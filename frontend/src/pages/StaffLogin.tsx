...
import { Mail, Lock, LogIn, Users, ArrowLeft, Eye, EyeOff } from "lucide-react";
...
export default function StaffLogin() {
  ...
  const onSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (user.role !== "staff") {
        logout();
        toast.error("This portal is for staff only. Please use citizen login.");
        setLoading(false);
        return;
      }
      setLoading(false);
  ...
  if (redirecting) {
    return <RedirectLoader message="Redirecting to Staff Dashboard..." />;
  }
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <div className="flex flex-1 items-center justify-center bg-gradient-to-br from-orange/5 via-background to-green/5 p-4">
        <div className="w-full max-w-md">
          <div className="mb-6 flex flex-col items-center text-center">
            ...
            <p className="mt-1 text-sm text-muted-foreground">URBANRESOLVE · Municipal Staff</p>
          </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      id="email"
                      type="email"
                      placeholder="staff@urbanresolve.gov.in"
                      value={email}
