...
export default function StaffRegister() {
  ...
  const onSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      setLoading(false);
      toast.success("Staff account created! Waiting for admin approval.");
      setRedirecting(true);
      setTimeout(() => {
          ...
          <Card className="border-border/60 shadow-elegant">
            <CardContent className="p-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      id="email"
                      type="email"
                      placeholder="you@urbanresolve.gov.in"
                      value={email}
              ...
              <p className="mt-6 text-center text-sm text-muted-foreground">
                ...
                <Link to="/staff/login" className="font-semibold text-orange-600 hover:underline">
                  Sign in
                </Link>
              </p>
            </CardContent>
